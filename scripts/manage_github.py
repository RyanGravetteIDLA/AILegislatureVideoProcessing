...
def create_repository(config):
    ...
    command = f"GITHUB_TOKEN={token} gh repo create {username}/{repo_name} {visibility_flag} "
    if description:
...
def main():
    ...
    setup_parser.add_argument('--create', action='store_true', help='Create the repository if it doesn\'t exist')
