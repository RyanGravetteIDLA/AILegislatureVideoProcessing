...
def configure_git():
    ...
    logger.info(f"Git remote configured to: github.com/{credentials['username']}/{credentials['repo_name']}")
    return True
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Update the GitHub repository with the latest changes")
