...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Download videos from Idaho Legislature by year and category"
    )
    ...
    count = downloader.download_year_category(
        args.year, args.category, limit=args.limit
    )
